...
const fontSizeConfig = [
    ...
    { selector: '#menu.navbar-default .navbar-nav>li>a', percentage: 0.01, exponent: 0.9, cssProperty: 'fontSize', dependentOn: 'height' },
    { selector: '#menu.navbar-default .navbar-nav>li>a', percentage: 0.006, exponent: 0.9, cssProperty: 'margin-left', dependentOn: 'width' },
    { selector: '#menu.navbar-default .navbar-nav>li>a', percentage: 0.006, exponent: 0.9, cssProperty: 'margin-right', dependentOn: 'width' },
    ...
    { selector: '.services-text h2', percentage: 0.006, exponent: 0.9, resizingPoints: [[1640, 0.03]], freezeBelow: true, cssProperty: 'fontSize', dependentOn: 'width' },
    { selector: '.services-text li', percentage: 0.01, exponent: 0.9, cssProperty: 'fontSize', dependentOn: 'height' },
